    ...
    <div class="card-body">
      ...
      <form action="" method="post">
        <div class="input-group mb-3">
          <input type="text" class="form-control" placeholder="Username | Case Sensitive" name="nama" value="Username">
        ...
        <div class="input-group mb-3">
          <input type="password" class="form-control" placeholder="Password | Case Sensitive" name="alamat" value="Password">
          <div class="input-group-append">
            <div class="input-group-text">
